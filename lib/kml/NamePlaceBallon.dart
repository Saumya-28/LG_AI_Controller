...
<Document>
 ...
 <Placemark id="ab">
  ...
  static showChatResponse() => '''<?xml version="1.0" encoding="UTF-8"?>
<kml xmlns="http://www.opengis.net/kml/2.2" xmlns:gx="http://www.google.com/kml/ext/2.2" xmlns:kml="http://www.opengis.net/kml/2.2" xmlns:atom="http://www.w3.org/2005/Atom">
<Document>
 <name>About Data</name>
 <Style id="about_style">
   <BalloonStyle>
     <textColor>ffffffff</textColor>
     <text><![CDATA[<h1>Saumya Kolkata</h1>]]></text> <!-- Static string displayed in the balloon -->
     <bgColor>ff15151a</bgColor>
   </BalloonStyle>
 </Style>
 <Placemark id="ab">
   ...
   <LookAt>
     <longitude>0.620015</longitude> <!-- Longitude of Lleida, Spain -->
     <latitude>41.617592</latitude> <!-- Latitude of Lleida, Spain -->
     <heading>0.0</heading>
     <tilt>0.0</tilt>
     <range>11</range>
   </LookAt>
   ...
   <gx:balloonVisibility>1</gx:balloonVisibility>
   <Point>
     <coordinates>0.620015,41.617592,0</coordinates> <!-- Coordinates of Lleida, Spain -->
   </Point>
 </Placemark>
</Document>
</kml>''';
